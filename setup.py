...
our_modules = [
    Extension("hw13", ["hw13.pyx"], language="c++", extra_compile_args=['-fopenmp'], extra_link_args=['-fopenmp']),
    Extension("hw14", ["hw14.pyx"], language="c++", extra_compile_args=['-fopenmp',], extra_link_args=['-fopenmp']),
    Extension("hw14opt",["hw14.pyx"], language="c++", extra_compile_args=['-fopenmp'], extra_link_args=['-fopenmp'])
]
