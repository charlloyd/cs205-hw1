...
our_modules = [
               #Extension("hw13", ["hw13.pyx"], extra_compile_args=['-fopenmp','-O3'], extra_link_args=['-fopenmp']),
    Extension("hw14", ["hw14.pyx"], extra_compile_args=['-fopenmp',], extra_link_args=['-fopenmp']),
    Extension("hw14opt",["hw14.pyx"], extra_compile_args=['-fopenmp','-O3'], extra_link_args=['-fopenmp'])
]
